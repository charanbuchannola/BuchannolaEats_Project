      ...
      <div className="flex flex-col md:flex-row justify-between gap-10">
        ...
        <div className="flex-1">
          ...
          <div className="flex items-center gap-2">
            ...
            />
            <Button className="bg-orange-400 hover:bg-hoverOrange">
              Search
            </Button>
          </div>
          ...
          <div>
            ...
            <div className="grid md:grid-cols-3 gap-4">
              {[1, 2, 3].map((_item: number, _idx: number) => (
                <Card className="bg-white dark:bg-gray-800 shadow-xl rounded-xl overflow-hidden hover:shadow-2xl transition-shadow duration-300">
                  ...
                  <CardFooter className="p-4 border-t dark:border-t-gray-700 border-t-gray-100 text-white flex justify-end">
                    <Link to={`/restaurant/${123}`}>
                      <Button className="bg-orange-400 hover:bg-hoverOrange font-semibold py-2 px-4 rounded-full shadow-md transition-colors duration-200">
                        View Menus
                      </Button>
                    </Link>
                  </CardFooter>
